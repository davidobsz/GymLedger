        ...
        public GetSessionView Get()
        {
            ...
            using (Data.DataContext db = new Data.DataContext())
            {
                ...
                if (this.Query.UniqueId != "0000")
                {
                    ...
                    var sessions1 = (from s in db.Sessions
                    ...
                    var sets1 = db.Sets
                                .Where(s => s.Session.User.Id == user1.Id)
                                .Select(s => new
                                {
                                    s.SessionId,
                                    Set = new SetView
                    ...
                    {
                        var sets2 = sets1.Where(set => set.SessionId == session.SessionId)
                                           .Select(set => set.Set)
                                           .ToList();
                        session.Sets = sets2;
                    ...
                    getSessionView.Sessions = sessions1;
