...
$(document).ready(function () {
    // Get the URL from the data attribute of the hidden div
    var chartDataUrl = $('#sessionDataUrl').data('url');
        ...
        success: function (data) {
            ...
            if (data.success) {
                ...
                new Chart(ctx, {
                    type: 'bar',
                    data: {
                        labels: data.Data.Exercises,  // Using the Exercise data from the response
                        datasets: [{
                            label: 'Exercises',
                            data: data.Data.Progress,   // Using the Sessions data from the response
                            borderWidth: 1
                        }]
                    },
                    options: {
